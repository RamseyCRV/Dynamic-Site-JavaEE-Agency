...
/**
 * Servlet implementation class SUtilizatori
 */
@WebServlet("/SUtilizatori")
public class SUtilizatori extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String del="DELETE FROM utilizatori where User='"+User+"'";
			s.executeUpdate(del);
