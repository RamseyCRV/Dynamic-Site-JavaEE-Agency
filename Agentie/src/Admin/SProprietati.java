...
/**
 * Servlet implementation class SProprietati
 */
@WebServlet("/SProprietati")
public class SProprietati extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String del="DELETE FROM proprietati where Id='"+Id+"'";
			s.executeUpdate(del);
