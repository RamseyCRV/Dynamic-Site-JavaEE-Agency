...
/**
 * Servlet implementation class MOperatii
 */
@WebServlet("/MOperatii")
public class MOperatii extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			String mod="update operatii set Operatie='"+Operatie+"' where Id='"+Id+"'";
			s.executeUpdate(mod);
